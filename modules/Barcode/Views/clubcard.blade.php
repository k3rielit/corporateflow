...
<div class="clubcard-container">

    <div class="tesco-logo">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 251.6 71.4" width="60" xml:space="preserve">
            <style type="text/css">
    ...
    <div class="clubcard-label">Clubcard</div>

    <div class="clubcard-barcode">
        <svg class="barcode"
             jsbarcode-value="{{ $value }}"
             jsbarcode-width="3"
             jsbarcode-height="75"
             jsbarcode-font="serif">
        </svg>
    </div>

</div>

{{-- Imitate clubcard application UI's style --}}
<style>
    .clubcard-container {
        display: flex;
        padding: 1em;
